...
| 3 | WhatIsCitixen | Tabla de 2 modos (`#gobierno` anchor). **Flipeada jun 2026 (participación primero):** izquierda **Modo Comunidad** (navy, entrada, "Empezás acá · 6 meses gratis"), derecha **Presupuesto participativo continuo** (coral, "Cuando estés listo", sub "Créditos Cívicos" como mecanismo). Las clases CSS `what-is-col-economy`/`--community` llevan color semántico (coral/navy), no posición — se reordenaron los `<th>` sin tocar CSS. La nota al pie encuadra el upgrade como switch, no como migración ni como fallback. |
