...
- `/soyvecino` — landing dedicada al vecino. Renombrada desde `/creditos-civicos` (mayo 2026). Mantiene la narrativa de 7 actos original. El hero va **sin eyebrow** (se retiró "Sos vecino" en jun 2026 — el formato etiqueta-conversacional leía a IA; misma decisión que en `/soygobierno`).
