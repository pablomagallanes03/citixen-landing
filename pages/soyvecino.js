  ...
  return (
    <div className="ep-cta-track ep-cta-track--citizen fade-up delay-1">
      ...
      <div className="ep-city-download">
        ...
        {/* iOS — reemplazar este <span> por <a href={APP_STORE_URL} ...> cuando la app esté publicada (jun 2026) */}
        <span className="ep-store-btn ep-store-btn--soon" aria-disabled="true">
