...
const APP_STORE_URL = 'https://apps.apple.com/ar/app/citixen-app/id6776739061'
...
function CitySearchCTA() {
  ...
  return (
    <div className="ep-cta-track ep-cta-track--citizen fade-up delay-1">
      ...
      <div className="ep-city-download">
        <a href={PLAY_STORE_URL} target="_blank" rel="noopener noreferrer" className="ep-store-btn">
        ...
        <a href={APP_STORE_URL} target="_blank" rel="noopener noreferrer" className="ep-store-btn">
