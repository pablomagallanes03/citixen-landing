        ...
        <section className="bg-white py-20 px-4 sm:px-6 lg:px-8">
            <div className="max-w-7xl mx-auto text-center">
                ...
                <p className="text-lg text-gray-600 max-w-2xl mx-auto mb-12 leading-relaxed">
                    Citixen transforma los impuestos en decisiones. A través de un sistema simple y transparente, puedes apoyar directamente proyectos que impactan en tu comunidad.
                </p>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12">
                    <div className="text-center">
                        ...
                        <h3 className="text-xl font-semibold mb-2">Realizas tus aportes fiscales</h3>
                        <p className="text-gray-600">Continúas con tus aportes fiscales como siempre.</p>
                    </div>
                    <div className="text-center">
                    ...
                    <div className="text-center">
                        ...
                        <h3 className="text-xl font-semibold mb-2">Asignas a proyectos</h3>
                        <p className="text-gray-600">Dirige tus tokens a proyectos sociales que impacten tu comunidad.</p>
                    </div>
                </div>
            </div>
        </section>
